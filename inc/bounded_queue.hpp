...
// PacketPtr get_pooled_packet() {
//     bb_context_packet* raw = global_pool.acquire();
//     if (!raw) return nullptr;
    
//     // When this shared_ptr's reference count hits 0, it releases back to the pool
...
// 2. Add 'inline' to the function so the linker knows to merge duplicates
